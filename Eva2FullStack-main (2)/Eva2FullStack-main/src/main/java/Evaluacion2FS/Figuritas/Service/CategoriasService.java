...
import Evaluacion2FS.Figuritas.Repository.CategoriasRepository;
...
public class CategoriasService {
    ...
    private CategoriasDTO convertirADTO(Categorias categoria){
        ...
        dto.setId_producto(categoria.getProducto().getId_producto());
        return dto;
    }
    ...
    public Categorias convertirAEntidad(CategoriasDTO dto) {
        ...
        Producto prod=productoRepository.findById(dto.getId_producto())
            .orElseThrow(()->new RuntimeException("Producto no encontrado con ID:"+dto.getId_producto()));
        categoria.setProducto(prod);
        return categoria;
    }
